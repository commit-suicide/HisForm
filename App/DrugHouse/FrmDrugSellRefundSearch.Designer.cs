namespace App.DrugHouse {
	partial class FrmDrugSellRefundSearch {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmDrugSellRefundSearch));
			...
			this.skinPanel1.Controls.Add(this.skinDateTimePicker2);
			...
			this.skinTextBox1.SkinTxt.WaterText = "摆药单号查询";
			this.skinTextBox1.TabIndex = 7;
			this.skinTextBox1.TextAlign = System.Windows.Forms.HorizontalAlignment.Left;
			this.skinTextBox1.WaterColor = System.Drawing.Color.FromArgb(((int)(((byte)(127)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
			this.skinTextBox1.WaterText = "摆药单号查询";
			...
			this.skinButton1.Location = new System.Drawing.Point(437, 10);
			...
			this.skinDateTimePicker2.Location = new System.Drawing.Point(305, 10);
			this.skinDateTimePicker2.Name = "skinDateTimePicker2";
			this.skinDateTimePicker2.Size = new System.Drawing.Size(114, 28);
			this.skinDateTimePicker2.TabIndex = 16;
			this.skinDateTimePicker2.text = "结束时间";
			// 
			// skinDateTimePicker1
			// 
			...
			this.skinDateTimePicker1.Location = new System.Drawing.Point(179, 10);
			this.skinDateTimePicker1.Name = "skinDateTimePicker1";
			this.skinDateTimePicker1.Size = new System.Drawing.Size(114, 28);
			this.skinDateTimePicker1.TabIndex = 16;
			this.skinDateTimePicker1.text = "开始时间";
			// 
			// grd
			// 
			...
			// Column4
			// 
			this.Column4.HeaderText = "（医护）申请人";
			this.Column4.Name = "Column4";
			// 
			// Column5
			// 
			this.Column5.HeaderText = "（总）金额";
			...
			this.Name = "FrmDrugSellRefundSearch";
			this.ShowDrawIcon = false;
			this.Text = "药房发药退药查询";
			this.Load += new System.EventHandler(this.FrmDrugSellRefundSearch_Load);
