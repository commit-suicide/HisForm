namespace App.DrugHouse {
	partial class FrmDrugLossEdit {
		...
		private void InitializeComponent() {
			...
			this.skinComboBox1.WaterText = "请选择报损药房";
			// 
			// label6
			// 
			...
			this.skinTextBox6.WaterText = "请选择报损时间";
			...
			this.Name = "FrmDrugLossEdit";
			this.Text = "药房报损详情";
			this.Load += new System.EventHandler(this.FrmDrugLossEdit_Load);
