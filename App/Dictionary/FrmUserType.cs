...
namespace App.Dictionary {
	public partial class FrmUserType : CCSkinMain {
		//****************************************************************************************************
		//委托
		...
		private void showData() {
			DataTable dt = new ModUserType().setWhere("id > 0", true).getSelect();
			if (dt == null) {
		...
		private void btnInsert_Click(object sender, EventArgs e) {
			FrmUserTypeEdit frm = new FrmUserTypeEdit(0);
		...
		private void btnUpdate_Click(object sender, EventArgs e) {
			FrmUserTypeEdit frm = new FrmUserTypeEdit(Convert.ToInt32(grd.CurrentRow.Cells["id"].Value));
			if (frm.ShowDialog() == DialogResult.OK) {
				showData();
			}
		}
