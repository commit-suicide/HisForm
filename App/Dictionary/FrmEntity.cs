...
namespace App.Dictionary {
	public partial class FrmEntity : CCSkinMain {
		//****************************************************************************************************
		//委托
		...
		private void btnInsert_Click(object sender, EventArgs e) {
			FrmEntityEdit frm = new FrmEntityEdit(0);
		...
		private void btnUpdate_Click(object sender, EventArgs e) {
			FrmEntityEdit frm = new FrmEntityEdit(Convert.ToInt32(grd.CurrentRow.Cells["id"].Value));
			if (frm.ShowDialog() == DialogResult.OK) {
				showData();
			}
		}
