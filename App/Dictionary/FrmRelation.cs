...
namespace App.Dictionary {
	public partial class FrmRelation : CCSkinMain {
		//****************************************************************************************************
		//委托
		...
		private void showData() {
			DataTable dt = new ModRelation().setWhere("id > 0", true).getSelect();
			if (dt == null) {
		...
		private void btnInsert_Click(object sender, EventArgs e) {
			FrmRelationEdit frm = new FrmRelationEdit(0);
		...
		private void btnUpdate_Click(object sender, EventArgs e) {
			FrmRelationEdit frm = new FrmRelationEdit(Convert.ToInt32(grd.CurrentRow.Cells["id"].Value));
			if (frm.ShowDialog() == DialogResult.OK) {
				showData();
			}
		}
