namespace App.Dictionary
{
    partial class FrmCure
    {
        ...
        private void InitializeComponent()
        {
			...
			this.grd.Size = new System.Drawing.Size(971, 540);
			this.grd.TabIndex = 3;
			...
			// Column1
			// 
			this.Column1.DataPropertyName = "CURENAME";
			...
			// Column2
			// 
			this.Column2.DataPropertyName = "SPELL";
			...
			// Column3
			// 
			this.Column3.DataPropertyName = "MEDICINECODE";
			...
			// Column4
			// 
			this.Column4.DataPropertyName = "UNITID";
			...
			// Column5
			// 
			this.Column5.DataPropertyName = "CHARGETYPEID";
			...
			// Column6
			// 
			this.Column6.DataPropertyName = "SPCE";
			...
			// Column7
			// 
			this.Column7.DataPropertyName = "FINANCETYPEID";
			...
			// Column8
			// 
			this.Column8.DataPropertyName = "INVOICETYPEID";
			...
			// 是否可用
			// 
			this.是否可用.DataPropertyName = "ISPASS";
			this.是否可用.HeaderText = "是否可用";
			this.是否可用.Name = "是否可用";
			this.是否可用.ReadOnly = true;
			// 
			// skinToolStrip1
			// 
        ...
        private System.Windows.Forms.DataGridViewTextBoxColumn 是否可用;
    }
}