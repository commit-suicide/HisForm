namespace App.Dictionary {
	partial class FrmCertificateType {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmCertificateType));
			...
			// Column6
			// 
			this.Column6.DataPropertyName = "certificateType";
			this.Column6.HeaderText = "证件类型";
			...
			this.Name = "FrmCertificateType";
			this.Shadow = false;
			this.ShowBorder = false;
			this.ShowDrawIcon = false;
			this.ShowIcon = false;
			this.Text = "";
			this.Load += new System.EventHandler(this.FrmCertificateType_Load);
