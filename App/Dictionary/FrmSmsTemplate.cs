...
namespace App.Dictionary {
	public partial class FrmSmsTemplate : CCSkinMain {
		//****************************************************************************************************
		//委托
		...
		private void showData() {
			DataTable dt = new ModSmsTemplate().setWhere("id > 0", true).getSelect();
			if (dt == null) {
		...
		private void btnInsert_Click(object sender, EventArgs e) {
			FrmSmsTemplateEdit frm = new FrmSmsTemplateEdit(0);
		...
		private void btnUpdate_Click(object sender, EventArgs e) {
			FrmSmsTemplateEdit frm = new FrmSmsTemplateEdit(Convert.ToInt32(grd.CurrentRow.Cells["id"].Value));
			if (frm.ShowDialog() == DialogResult.OK) {
				showData();
			}
		}
