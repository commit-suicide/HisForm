namespace App.Dictionary {
	partial class FrmUserSource {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmUserSource));
			...
			// Column5
			// 
			this.Column5.DataPropertyName = "userSource";
			this.Column5.HeaderText = "患者来源";
			...
			this.Name = "FrmUserSource";
			this.Shadow = false;
			this.ShowBorder = false;
			this.ShowDrawIcon = false;
			this.ShowIcon = false;
			this.Text = "";
			this.Load += new System.EventHandler(this.FrmUserSource_Load);
