...
namespace App.Dictionary {
	public partial class FrmHospital : CCSkinMain {
		//****************************************************************************************************
		//委托
		...
		private void btnInsert_Click(object sender, EventArgs e) {
			FrmHospitalEdit frm = new FrmHospitalEdit(0);
		...
		private void btnUpdate_Click(object sender, EventArgs e) {
			FrmHospitalEdit frm = new FrmHospitalEdit(Convert.ToInt32(grd.CurrentRow.Cells["id"].Value));
			if (frm.ShowDialog() == DialogResult.OK) {
				showData();
			}
		}
