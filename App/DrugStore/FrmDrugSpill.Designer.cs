namespace App.DrugStore {
	partial class FrmDrugSpill {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmDrugSpill));
			...
			this.grd.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle9;
			...
			this.grd.RowsDefaultCellStyle = dataGridViewCellStyle12;
			...
			this.Column1.HeaderText = "报溢单号";
			this.Column1.Name = "Column1";
			// 
			// Column2
			// 
			this.Column2.FillWeight = 79.5612F;
			this.Column2.HeaderText = "报溢药房";
			...
			this.Name = "FrmDrugSpill";
			this.ShowDrawIcon = false;
			this.Text = "药库报溢";
			this.Load += new System.EventHandler(this.FrmDrugSpill_Load);
