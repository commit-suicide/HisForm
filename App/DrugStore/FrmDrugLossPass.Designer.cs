namespace App.DrugStore {
	partial class FrmDrugLossPass {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmDrugLossPass));
			...
			this.btnUpdate.ToolTipText = "查看(U)";
			// 
			// btnRefresh
			// 
			...
			// Column5
			// 
			this.Column5.HeaderText = "状态（审核中、已审核）";
			...
			this.Name = "FrmDrugLossPass";
			this.ShowDrawIcon = false;
			this.Text = "药库报损审核";
			this.Load += new System.EventHandler(this.FrmDrugLossPass_Load);
