namespace App.DrugStore {
	partial class FrmDrugLoss {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmDrugLoss));
            ...
            "未审核",
            "已审核"});
			this.skinComboBox1.Location = new System.Drawing.Point(524, 13);
			this.skinComboBox1.Name = "skinComboBox1";
			this.skinComboBox1.Size = new System.Drawing.Size(99, 22);
			...
			this.skinTextBox3.Location = new System.Drawing.Point(350, 10);
			...
			this.skinTextBox1.SkinTxt.WaterText = "报损单号";
			this.skinTextBox1.TabIndex = 7;
			this.skinTextBox1.TextAlign = System.Windows.Forms.HorizontalAlignment.Left;
			this.skinTextBox1.WaterColor = System.Drawing.Color.FromArgb(((int)(((byte)(127)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
			this.skinTextBox1.WaterText = "报损单号";
			...
			// Column1
			// 
			this.Column1.FillWeight = 53.87931F;
			this.Column1.HeaderText = "报损单号";
			this.Column1.Name = "Column1";
			// 
			// Column2
			// 
			this.Column2.FillWeight = 79.5612F;
			this.Column2.HeaderText = "报损药房";
			this.Column2.Name = "Column2";
			this.Column2.Width = 148;
			// 
			// Column3
			// 
			this.Column3.FillWeight = 102.4757F;
			...
			// Column4
			// 
			this.Column4.FillWeight = 122.9209F;
			this.Column4.HeaderText = "报损日期";
			this.Column4.Name = "Column4";
			this.Column4.Width = 228;
			// 
			// Column5
			// 
			this.Column5.FillWeight = 141.1629F;
			this.Column5.HeaderText = "状态（未提交、审核中、已审核）";
			this.Column5.Name = "Column5";
			this.Column5.Width = 262;
			// 
			// FrmDrugLoss
			// 
			...
			this.Name = "FrmDrugLoss";
			this.Text = "药库报损";
			this.Load += new System.EventHandler(this.FrmDrugLoss_Load);
