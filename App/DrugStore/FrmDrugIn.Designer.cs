namespace App.DrugStore {
	partial class FrmDrugIn {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmDrugIn));
			...
			this.skinPanel1.Controls.Add(this.skinDateTimePicker1);
            ...
            "未审核",
            "已审核"});
			this.skinComboBox3.Location = new System.Drawing.Point(516, 10);
			...
			this.skinTextBox1.SkinTxt.WaterText = "入库单号";
			this.skinTextBox1.TabIndex = 7;
			this.skinTextBox1.TextAlign = System.Windows.Forms.HorizontalAlignment.Left;
			this.skinTextBox1.WaterColor = System.Drawing.Color.FromArgb(((int)(((byte)(127)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
			this.skinTextBox1.WaterText = "入库单号";
			...
			this.skinButton1.Location = new System.Drawing.Point(637, 10);
			...
			// Column2
			// 
			this.Column2.HeaderText = "供货日期";
			this.Column2.Name = "Column2";
			// 
			// Column3
			// 
			this.Column3.HeaderText = "收货库房";
			this.Column3.Name = "Column3";
			// 
			// Column4
			// 
			this.Column4.HeaderText = "入库单号";
			...
			this.skinToolStrip1.TabIndex = 12;
			...
			this.Text = "药库入库申请";
			this.Load += new System.EventHandler(this.FrmDrugIn_Load);
